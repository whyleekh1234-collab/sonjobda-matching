      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="sticky top-[108px] z-30 mt-6 grid grid-cols-2 gap-3 bg-muted pb-3 sm:mt-8 sm:gap-4 sm:pb-4 sm:grid-cols-3">
          <button onClick={() => { setActiveSection("received"); setFilterStatus("all"); }}
            className={`rounded-xl border p-4 text-left transition-all sm:p-6 ${activeSection === "received" ? "border-primary bg-primary/5 shadow-md" : "border-border bg-surface shadow-card hover:border-primary/30 hover:shadow-md"}`}>
          ...
          <button onClick={() => setActiveSection("sent")}
            className={`rounded-xl border p-4 text-left transition-all sm:p-6 ${activeSection === "sent" ? "border-emerald-500 bg-emerald-50 shadow-md" : "border-border bg-surface shadow-card hover:border-emerald-300 hover:shadow-md"}`}>
            <div className="flex items-center justify-between">
              <div>
          ...
          <button onClick={() => setActiveSection("won")}
            className={`col-span-2 rounded-xl border p-4 text-left transition-all sm:col-span-1 sm:p-6 ${activeSection === "won" ? "border-amber-500 bg-amber-50 shadow-md" : "border-border bg-surface shadow-card hover:border-amber-300 hover:shadow-md"}`}>
            <div className="flex items-center justify-between">
              <div>
